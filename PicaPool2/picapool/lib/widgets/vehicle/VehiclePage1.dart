...
import 'package:picapool/widgets/vehicle/VehiclePage2.dart';

class VehiclePage1 extends StatefulWidget {
  @override
  State<VehiclePage1> createState() => _VehiclePage1State();
}

class _VehiclePage1State extends State<VehiclePage1> {
          ...
          children: [
            ...
            Padding(
              ...
              child: buildTextField(
                  label: 'Type:', hintText: 'e.g., car, bike, truck'),
            ),
            SizedBox(height: 10),
            Padding(
              padding: const EdgeInsets.only(left: 20.0, right: 20),
              child: Row(
                children: [
                  Expanded(
                    child: buildTextField(label: 'Year', hintText: '2000'),
                  ),
                  SizedBox(width: 10),
                  Expanded(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: buildTextField(label: 'KMs driven', hintText: '2000'),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: buildTextField(label: 'Specifications', hintText: 'abc'),
                  ),
                ],
              ),
            ),
