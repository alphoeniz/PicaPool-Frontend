...
class FurniturePage2 extends StatefulWidget {
  @override
  State<FurniturePage2> createState() => _FurniturePage2State();
}

class _FurniturePage2State extends State<FurniturePage2> {
