...
import 'package:picapool/widgets/furniture/FurniturePage2.dart';
import 'package:picapool/screens/sell/select_category_page.dart';

class FurniturePage1 extends StatefulWidget {
  @override
  State<FurniturePage1> createState() => _FurniturePage1State();
}

class _FurniturePage1State extends State<FurniturePage1> {
          ...
          children: [
            ...
            Padding(
              ...
              child: buildTextField(
                  label: 'Type:', hintText: 'e.g., desk, chair, bed'),
            ),
            SizedBox(height: 10),
            Padding(
              padding: const EdgeInsets.only(left: 20.0, right: 20),
              child: Row(
                children: [
                  Expanded(
                    child: buildTextField(label: 'Material', hintText: 'abc'),
                  ),
                  SizedBox(width: 10),
                  Expanded(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          items: ['centimeters', 'meters', 'feet', 'inch']
                              .map((unit) {
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: buildTextField(label: 'Height', hintText: '12'),
                      ),
                      SizedBox(width: 10),
                      Expanded(
                        child: buildTextField(label: 'Length', hintText: '12'),
                      ),
                      SizedBox(width: 10),
                      Expanded(
                        child: buildTextField(label: 'Breadth', hintText: '12'),
                      ),
                    ],
                  ),
                ],
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FurniturePage2()),
                    );
                  },
